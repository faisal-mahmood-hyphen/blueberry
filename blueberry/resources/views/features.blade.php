<x-app-layout :active="$active" :breadCrumbs="$breadCrumbs">
    @section('content')
        ...
        @if(hasPermissions($permissions,'add-new-feature'))
        ...
        @endif
        @if(hasPermissions($permissions,'edit-feature'))
    ...
    @section('scripts')
        <script>
            $(function () {
                ...
                @endif
                @if(hasPermissions($permissions,'delete-feature'))
