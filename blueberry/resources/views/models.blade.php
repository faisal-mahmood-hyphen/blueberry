<x-app-layout :active="$active" :breadCrumbs="$breadCrumbs">
    @section('content')
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        ...
                        @if(hasPermissions($permissions,'add-new-model'))
                            ...
                            <form class="form-horizontal" id="add-form">
                                <div class="card-body">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-6">
                                            <div class="form-group row">
                                                <label for="brand_id_edit" class="col-sm-12 col-form-label">Brands</label>
                                                <div class="col-sm-12">
        ...
        @endif
        @if(hasPermissions($permissions,'edit-brand'))
                            ...
                            <form class="form-horizontal" id="edit-form">
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-sm-6">
                                            <div class="form-group row">
                                                <label for="title-edit" class="col-sm-12 col-form-label">Name</label>
                                                <div class="col-sm-12">
    ...
    @section('scripts')
        <script>
            $(function () {
                ...
                @endif
                @if(hasPermissions($permissions,'edit-car-model'))
                ...
                @endif
                @if(hasPermissions($permissions,'delete-car-model'))
