<x-app-layout :active="$active" :breadCrumbs="$breadCrumbs">
    @section('content')
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        ...
                        @if(hasPermissions($permissions,'add-new-image'))
        ...
        @endif
        @if(hasPermissions($permissions,'edit-image'))
        ...
        <script>
            $(function () {
                ...
                var table = $("#example1").DataTable({
                    ...
                    ajax: {
                        url: '{!! route('car.images.index', ['carId' => $carId]) !!}',
                ...
                @endif
                @if(hasPermissions($permissions,'delete-image'))
