            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        ...
                        @if(hasPermissions($permissions,'add-new-customer'))
                            ...
                            <form class="form-horizontal" id="edit-form">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-6">
                                            <div class="form-group row">
                                                <label for="dob-edit" class="col-sm-12 col-form-label">Date of Birth</label>
                                                <div class="col-sm-12">
                                                    <input type="date" id="dob-edit" name="dob" class="form-control">
                                                    <span class="text-danger errors dob"></span>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="row">
                                        <div class="col-sm-6">
                                            <div class="form-group row">
                                                <label for="gender-edit" class="col-sm-12 col-form-label">Gender</label>
                                                <div class="col-sm-12">
                                                    <select id="gender-edit" name="gender" class="form-control">
                                                        <option value="">Select Gender</option>
                                                        <option value="male">Male</option>
                                                        <option value="female">Female</option>
                                                        <option value="others">Others</option>
                                        ...
                                        <div class="col-sm-6">
                                            <div class="form-group row">
                                                <label for="nationality-edit" class="col-sm-12 col-form-label">Nationality</label>
                                                <div class="col-sm-12">
                                        ...
                                        <div class="col-sm-12">
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-12">
                                                    ...
                                                    <span class="text-danger errors image"></span>
                                                    <img class="mt-2" src="" alt="Customer Image" id="image-update"
                                                         width="250">
                                                </div>
                                            </div>
                                        </div>
        ...
        <script>
            $(function () {
                ...
                $(document).on('click','.edit-record', function () {
                    ...
                    $('#nationality-edit').val(data.nationality);
