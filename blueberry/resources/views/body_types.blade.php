<x-app-layout :active="$active" :breadCrumbs="$breadCrumbs">
    @section('content')
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        ...
                        @if(hasPermissions($permissions,'add-new-body-types'))
        ...
        @endif
        @if(hasPermissions($permissions,'edit-body-types'))
        ...
        <script>
            $(function () {
                ...
                var table = $("#example1").DataTable({
                    ...
                    ajax: {
                        url: '{!! route('car.body.types.index') !!}',
                ...
                @endif
                @if(hasPermissions($permissions,'delete-body-types'))
                $(document).on('click','.delete-record', function () {
                    ...
                    Swal.fire({
                        ...
                        if (result.isConfirmed) {
                            $.ajax({
                                type: 'POST',
                                url: "{{ route('car.body.types.delete') }}",
                                data: {id:id},
                                success: function (res) {
                                    if (res.status) {
                                        $(document).Toasts('create', {
