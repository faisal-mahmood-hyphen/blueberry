        ...
        <script>
            $(function () {
                ...
                var table = $("#example1").DataTable({
                    ...
                    ajax: {
                        url: '{!! route('worldwild.cities',['countryId'=>$countryId,'stateId'=>$stateId]) !!}',
                ...
                $(document).on('switchChange.bootstrapSwitch','[data-bootstrap-switch]', function (event, state) {
                    ...
                    $.ajax({
                        type: 'POST',
                        url: "{{ route('worldwild.edit.city',['countryId'=>$countryId,'stateId'=>$stateId]) }}",
                        data: {id:id,status:status,country_id:countryId,state_id:stateId},
